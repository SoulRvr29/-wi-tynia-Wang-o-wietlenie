...
#define dioda01 3  // diody wokół modelu
#define dioda02 5  // dioda w przejściu do wieży
#define dioda03 6  // dioda przy wejściu
...
bool dioda01Stan = true;  // stan diod wł./wył.
bool dioda02Stan = true;
bool dioda03Stan = true;
bool diodyLogoStan = true;
...
void setup() {
  ...
  for (int x = 0; x < 250; x++) {  //początkowe rozświetlenie diod
...
void loop() {
  ...
  if (!digitalRead(przyciskPlus)) {
    if (tryb == 0 || tryb == 1 && jasnoscDiody01 < 250) jasnoscDiody01 += 1;
    if (tryb == 0 || tryb == 2 && jasnoscDiody02 < 250) jasnoscDiody02 += 1;
    if (tryb == 0 || tryb == 3 && jasnoscDiody03 < 250) jasnoscDiody03 += 1;
    if (tryb == 4 && jasnoscLogo < 250) jasnoscLogo += 1;
    delay(20);
    przypisywanieJasnosci();
  }

  if (!digitalRead(przyciskMinus)) {
    if (tryb == 0 || tryb == 1 && jasnoscDiody01 > 0) jasnoscDiody01 -= 1;
    if (tryb == 0 || tryb == 2 && jasnoscDiody02 > 0) jasnoscDiody02 -= 1;
    if (tryb == 0 || tryb == 3 && jasnoscDiody03 > 0) jasnoscDiody03 -= 1;
    if (tryb == 4 && jasnoscLogo > 0) jasnoscLogo -= 1;
...
void sterowaniePilotemTryb0() {
  ...
  if (value == przyciskBrightPlus && jasnoscDiody01 < 250) jasnoscDiody01 += 5;
  if (value == przyciskBrightPlus && jasnoscDiody02 < 250) jasnoscDiody02 += 5;
  if (value == przyciskBrightPlus && jasnoscDiody03 < 250) jasnoscDiody03 += 5;
  if (value == przyciskBrightMinus && jasnoscDiody01 > 0) jasnoscDiody01 -= 5;
  if (value == przyciskBrightMinus && jasnoscDiody02 > 0) jasnoscDiody02 -= 5;
  if (value == przyciskBrightMinus && jasnoscDiody03 > 0) jasnoscDiody03 -= 5;
...
void sterowaniePilotemTryb4() {
  ...
  if (value == przyciskBrightPlus && jasnoscLogo < 250) jasnoscLogo += 5;
  if (value == przyciskBrightMinus && jasnoscLogo > 0) jasnoscLogo -= 5;
